...
const areaColors: Record<LifeArea, string> = {
  ...
  body: "bg-green-100/80 text-green-700 dark:bg-green-900/30 dark:text-green-400",
  relationships: "bg-pink-100/80 text-pink-700 dark:bg-pink-900/30 dark:text-pink-400",
};
